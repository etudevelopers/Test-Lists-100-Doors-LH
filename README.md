# Test Lists — 100 doors — Learning Hour

A [Learning Hour] on writing test lists before coding, run across two weekly sessions on the "100 doors" kata:
week 1 produces the test list, week 2 implements it.
